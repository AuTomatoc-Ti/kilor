...
### A. Sentence-Level Emotional Register

The emotional particle **stands alone at the clause head**, before any temporal words:
...
The emotional particle is placed **immediately before the verb** (after the object and any oblique phrases, in the manner-adverb slot):
...
When both sentence-level and verb-level particles appear in the same clause:
...
| Colour | Particle | Phonological Type |
|:---|:---|:---|
...
- Do **not** affect the tone contours of adjacent words
- Do **not** count toward the last-3 tone domain of any word
...
|:---|:---|:---|
| **Form** | `a-`, `e-`, `i-`, `o-`, `u-`, `y-`, `ae-` (hyphenated) | `a`, `e`, `i`, `o`, `u`, `y`, `ae` (standalone, space-separated) |
| **Attaches to** | A noun root | A clause (sentence-level) or a verb |
| **Encodes** | Ontological class + definiteness | Emotional register |
| **Phonology** | Proclitic — flat mid-tone, external to root tone domain | Standalone particle — flat mid-tone, independent |
| **Optional?** | Required for definite/specific nouns; dropped for generic nouns unless emotionally coloured | Always optional |
