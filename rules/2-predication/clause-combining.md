# Kilor Clause Combining — Coordination & Conjunction
...
> `bau po lira` — "bread or water" (but not both)

### C. Inclusive Or — `pem` ("or" — either or both)

> `bau pem lira` — "bread or water" (possibly both)
...
*End of Clause Combining Specification.*